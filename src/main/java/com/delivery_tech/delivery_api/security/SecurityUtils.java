package com.delivery_tech.delivery_api.security;

import com.delivery_tech.delivery_api.model.Usuario; // Update this line if 'Usuario' is in 'model' package, or correct to the actual package
